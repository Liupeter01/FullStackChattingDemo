...
RestrictUserSearchingInput::RestrictUserSearchingInput(std::size_t max_length, QWidget *parent)
    : m_maxLen(max_length)
    , QLineEdit(parent)
{
...
{
    connect(this, &QLineEdit::textChanged, this, &RestrictUserSearchingInput::constraintTextLength);
}
