...
void MsgBubbleBase::paintEvent(QPaintEvent *event)
{
    ...
    if(m_role == ChattingRole::Sender){
        ...
        QPointF points[3] = {
            ...
            QPointF(sender_rect.x() + sender_rect.width() + triangle_width, 10 + triangle_width + triangle_width / 2),
            QPointF(sender_rect.x() + sender_rect.width(), 12 + this->triangle_width + 2)
        };
        ...
        /*draw a rectangular*/
        QRect receiver_rect(triangle_width, 0, this->width() - triangle_width, this->height());

        /*draw a triangle*/
        QPointF points[3] = {
            QPointF(receiver_rect.x(), 12),
            QPointF(receiver_rect.x() - triangle_width, 10 + triangle_width + triangle_width / 2),
