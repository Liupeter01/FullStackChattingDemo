...
PasswordDisplaySwitching::PasswordDisplaySwitching(QWidget *parent, Qt::WindowFlags f)
    : m_state()
    , QLabel(parent)
{
}
...
const LabelState &PasswordDisplaySwitching::getState() const
{
    return m_state;
}
...
void PasswordDisplaySwitching::mousePressEvent(QMouseEvent *event)
{
    if(event->button() == Qt::LeftButton){
        ...
        this->m_state.visiable = (!this->m_state.visiable ?
            LabelState::VisiableStatus::ENABLED : LabelState::VisiableStatus::DISABLED);
...
void PasswordDisplaySwitching::enterEvent(QEnterEvent *event)
{
    ...
    Tools::setQLableImage(this,
        this->m_state.visiable ? "show_passwd_selected.png": "invisiable_passwd_selected.png"
    );
...
void PasswordDisplaySwitching::leaveEvent(QEvent *event)
{
    ...
    Tools::setQLableImage(this,
        this->m_state.visiable ? "show_password.png": "invisiable_password.png"
    );
