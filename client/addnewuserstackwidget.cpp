...
void AddNewUserStackWidget::addNewWidgetItem(std::unique_ptr<UserNameCard> info)
{
    /*allocate memory*/
...
{
    std::unique_ptr<UserNameCard> info(std::make_unique<UserNameCard>(QString::number(0), "4.png", "test_name", "test_name","test_desc", Sex::Male));
    /*transfer ownership*/
