...
void ChattingDlgMainFrame::registerSearchEditAction()
{
    ...
    m_searchAction->setIcon(Tools::loadIcon(QT_DEMO_HOME "/res/search.png").value());
    ...
    m_cancelAction->setIcon(Tools::loadIcon(QT_DEMO_HOME "/res/close_transparent.png").value());
...
void ChattingDlgMainFrame::registerSearchEditSignal()
{
    ...
    connect(ui->search_user_edit, &QLineEdit::textChanged, this, [this](const QString &str){
        m_cancelAction->setIcon(Tools::loadIcon(str.isEmpty()?
            QT_DEMO_HOME "/res/close_transparent.png"
            :QT_DEMO_HOME "/res/close_search.png").value());
    });
