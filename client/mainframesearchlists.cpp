...
void MainFrameSearchLists::registerSignal()
{
    ...
    connect(this, &QListWidget::itemClicked, this, &MainFrameSearchLists::slot_item_clicked);
}
...
void MainFrameSearchLists::addStyleSheet()
{
    ...
    this->setStyleSheet("#search_list::item::selected{background-color:#d3d7d4;border:none;outline:none}");
    this->setStyleSheet("#search_list::item::hover{background-color:rgb(206,207,208);border:none;outline:none}");
