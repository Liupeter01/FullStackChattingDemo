...
bool  redis::RedisReply::isSuccessful() const {
          ...
          case REDIS_REPLY_STATUS:
                    ...
                    return std::string(m_redisReply->str) == "OK" || std::string(m_redisReply->str) == "ok";
          ...
          case REDIS_REPLY_STRING:
                    ...
                    return m_redisReply->str != nullptr && std::string(m_redisReply->str).length() > 0;

          case REDIS_REPLY_NIL:
                    return false; // Nil replies indicate no data found (e.g., key doesn't exist)
