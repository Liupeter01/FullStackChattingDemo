...
::grpc::Status 
grpc::GrpcDistributedChattingImpl::SendFriendRequest(
...
::grpc::Status 
grpc::GrpcDistributedChattingImpl::ConfirmFriendRequest(
          ::grpc::ServerContext* context, 
...
::grpc::Status 
grpc::GrpcDistributedChattingImpl::FriendshipVerification(
          ::grpc::ServerContext* context, 
          const ::message::AuthoriseRequest* request, 
          ::message::AuthoriseResponse* response) 
{
...
::grpc::Status 
grpc::GrpcDistributedChattingImpl::NormalChattingMsg(
          ::grpc::ServerContext* context, 
