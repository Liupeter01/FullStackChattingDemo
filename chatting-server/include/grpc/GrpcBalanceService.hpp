...
struct gRPCBalancerService {
  ...
  static message::LoginChattingResponse userLoginToServer(std::size_t uuid, const std::string &token) {
  ...
  static message::PeerResponse getPeerChattingServerLists(const std::string &cur_name) {
    grpc::ClientContext context;
  ...
  static message::PeerResponse getPeerGrpcServerLists(const std::string& cur_name) {
            grpc::ClientContext context;
            message::PeerListsRequest request;
            message::PeerResponse response;
  ...
  static message::GrpcChattingServerResponse registerGrpcServer(const std::string& name, const std::string& host, const std::string& port) {
            grpc::ClientContext context;
  ...
  static message::GrpcChattingServerResponse chattingServerShutdown(const std::string& name) {
            grpc::ClientContext context;
