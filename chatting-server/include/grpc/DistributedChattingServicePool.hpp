...
namespace stubpool{
          ...
          */
          namespace details {
                    class DistributedChattingServicePoolImpl
                              : public connection::ConnectionPool<DistributedChattingServicePoolImpl, typename message::DistributedChattingService::Stub>
                    {
          ...
          * class DistributedChattingServicePool
          */
          class DistributedChattingServicePool :public details::DistributedChattingServicePoolImpl{
          public:
                    DistributedChattingServicePool(const grpc::string &host, const grpc::string& port)
                              : m_host(host)
                              , m_port(port)
