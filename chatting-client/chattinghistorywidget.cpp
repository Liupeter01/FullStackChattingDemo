...
void ChattingHistoryWidget::setUserInfo(std::shared_ptr<FriendChattingHistory> info) {
    m_userinfo = info;
}
...
std::shared_ptr<FriendChattingHistory> ChattingHistoryWidget::getChattingContext(){
    return m_userinfo;
}
