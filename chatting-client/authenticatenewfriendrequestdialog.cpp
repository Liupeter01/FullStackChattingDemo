...
AuthenticateNewFriendRequestDialog::AuthenticateNewFriendRequestDialog(QWidget *parent)
    : QDialog(parent)
    , ui(new Ui::AuthenticateNewFriendRequestDialog)
...
bool AuthenticateNewFriendRequestDialog::eventFilter(QObject *object, QEvent *event)
{
...
void AuthenticateNewFriendRequestDialog::addNewTag2Container(const QString &text)
{
    /*store all tags*/
...
void AuthenticateNewFriendRequestDialog::addNewTag2InputTag(const QString &text)
{
    /*clear input text*/
    ui->tag_input->clear();
...
void AuthenticateNewFriendRequestDialog::addNewTag2ExistingTag(const QString &text)
{
...
void AuthenticateNewFriendRequestDialog::createSelectedTag(const QString &text, UserTagWidget *widget)
{
...
void AuthenticateNewFriendRequestDialog::createExistingTag(const QString &text, OnceClickableQLabel *widget)
{
...
void AuthenticateNewFriendRequestDialog::on_cancel_button_clicked()
{
   ...
   * it!*/
    ...
    SendNode<QByteArray, std::function<uint16_t(uint16_t)>> send_buffer(
        static_cast<uint16_t>(ServiceType::SERVICE_FRIENDREQUESTCONFIRM), json_data,
...
void AuthenticateNewFriendRequestDialog::slot_input_tag_textchange(const QString &text)
{
    /*no text*/
    if (text.isEmpty()) {
        /*clear text*/
...
void AuthenticateNewFriendRequestDialog::slot_choose_tag_by_click(QString str, LabelState state)
{
